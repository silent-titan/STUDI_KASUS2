    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            ...
            <ul class="space-y-2 text-gray-700">
                ...
                <li>
                    <a href="logout.php" onclick="return confirm('Apakah anda yakiningin keluar?');" class="block text-red-600 hover:underline font-medium">Logout</a>
                </li>
            </ul>
        </aside>
        <!-- Main Content -->
            ...
            <table class="min-w-full table-auto border border-gray-300 text-sm">
                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                        ...
                        echo "<td class='border p-2 text-center space-x-2'> <a href='edit_artikel.php?id_artikel={$data['id_artikel']}' class='text-blue-600 hover:underline'>Edit</a><a href='delete_artikel.php?id_artikel={$data['id_artikel']}'onclick='return confirm(\"Yakin ingin menghapus?\")'class='text-red-600 hover:underline'>Hapus</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
